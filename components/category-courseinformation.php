            ...
            ?>
                ...
                <?php if (get_row_index() % 2 == 0) : ?>
                    <div class="type-right row">
                        ...
                        <h4 class="mb-0" style="color: <?php the_sub_field('course_type_header_color'); ?>"><em style="font-style:normal; padding: 10px; background: <?php the_sub_field('course_type_header_bg'); ?>;"><?php the_sub_field('course_type_header'); ?></em></h4>
